...
INSERT INTO `items` (`name`, `label`, `weight`) VALUES
	('alive_chicken', 'Gà sống', 1),
	('slaughtered_chicken', 'Giết mổ gà', 1),
	('packaged_chicken', 'Chicken fillet', 1),
	('fish', 'Cá', 1),
	('stone', 'Sỏi', 1),
	('washed_stone', 'Sỏi đã rửa', 1),
	('copper', 'Đồng', 1),
	('iron', 'Sắt', 1),
	('gold', 'Vàng', 1),
	('diamond', 'Kim cương', 1),
	('wood', 'Gỗ', 1),
	('cutted_wood', 'Cắt gỗ', 1),
	('packaged_plank', 'Gỗ đóng gói', 1),
	('petrol', 'Dầu', 1),
	('petrol_raffin', 'Dầu đã xử lý', 1),
	('essence', 'Gas', 1),
	('wool', 'Len', 1),
	('fabric', 'Sợi vải', 1),
	('clothe', 'Vải', 1)
