Locales['hu'] = {
  ...
  ['job_wear']                  = 'Munka ruha',
  ['bank_deposit_returned']     = 'Visszakaptál ~g~$%s~s~ letétet.',
  ['bank_deposit_taken']        = 'Biztonsági letétet ~r~$%s~s~ fizettél.',
  ...
  ['max_limit']                 = 'nem tudsz többet szállítani ~y~%s~s~',
  ['not_enough']                = 'Nincs elég ~y~%s~s~ hogy folytasd.',
