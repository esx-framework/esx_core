...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('police',0,'recruit','Học việc',20,'{}','{}'),
	('police',1,'officer','Nhân viên văn phòng',40,'{}','{}'),
	('police',2,'sergeant','Trung sĩ',60,'{}','{}'),
	('police',3,'lieutenant','Trung úy',85,'{}','{}'),
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Băng qua đường liên tục trái phép', 40, 0),
	('Lái xe ở phía bên trái của đường', 250, 0),
	('Quay đầu xe trái phép', 250, 0),
	('Lái xe địa hình trái phép', 170, 0),
	('Từ chối một mệnh lệnh hợp pháp', 30, 0),
	('Dừng xe trái phép', 150, 0),
	('Bãi đậu xe trái phép', 70, 0),
