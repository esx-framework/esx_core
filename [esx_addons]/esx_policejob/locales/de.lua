Locales['de'] = {
  ...
  ['armory_componenttitle'] = 'Waffenkammer - Waffen Attachments',
  ['armory_bought'] = 'Du hast dir %s für $%s gekauft',
  ['armory_money'] = 'Du kannst dir die Waffe nicht leisten',
  ['armory_hascomponent'] = 'Du hast das Attachment bereits!',
  ...
  ['garage_prompt'] = 'Drücke [E], um das Garagenmenü zu öffnen.',
  ...
  -- Action Menu
  ['citizen_interaction'] = 'Zivilinteraktionen',
