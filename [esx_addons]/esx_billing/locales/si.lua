Locales['si'] = {
  ...
  ['paid_invoice'] = 'plačali ste račun v višini ~r~$%s~s~',
  ['no_invoices'] = 'v tem trenutku nimate računov za plačilo',
  ['received_payment'] = 'prejeli ste plačilo v višini ~r~$%s~s~',
  ['player_not_online'] = 'igralec ni prijavljen',
  ['no_money'] = 'nimate dovolj denarja za plačilo tega računa',
  ['target_no_money'] = 'igralec ~r~does not~s~ ima dovolj denarja za plačilo računa!',
