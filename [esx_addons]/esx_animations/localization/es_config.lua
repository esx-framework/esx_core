...
Config.Animations = {
...

	{
		...
		items = {
	    	...
	    	{label = "Que, pelea?", type = "anim", data = {lib = "anim@deathmatch_intros@unarmed", anim = "intro_male_unarmed_e"}},
...

	{
		...
		items = {
	    	{label = "Normal H", type = "attitude", data = {lib = "move_m@confident", anim = "move_m@confident"}},
	    	{label = "Normal M", type = "attitude", data = {lib = "move_f@heels@c", anim = "move_f@heels@c"}},
