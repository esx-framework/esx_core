Locales['vi'] = {
    ...
    ['already_own'] = 'bạn đã sở hữu: %s',
    ['not_enough_money'] = 'bạn không đủ tiền để mua mod này!',
    ['purchased'] = 'bạn đã mua bản mod!',
    ['press_custom'] = 'nhấn ~b~[E]~s~ để cá nhân hóa chiếc xe của bạn',
    ['level'] = 'cấp độ %s',
    ['neon'] = 'neon',
