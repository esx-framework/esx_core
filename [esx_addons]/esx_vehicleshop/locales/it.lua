Locales['it'] = {
  -- global menus
  ['not_enough_in_society']   = 'Non cè più quell oggetto nella società!',
  ...
  ['generic_shopitem']        = '€%s',
  ['vehicle_dealer']          = 'Veicolo - Concessionario di autos',
  ['vehicle_menu']            = 'Presiona [E] per restituire il veicolo noleggiato',
  ...
  ['deposit_stock']           = 'Azione depositaria',
  ['take_stock']              = 'Ritirare le azioni',
