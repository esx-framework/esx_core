Locales['hu'] = {
  ...
  -- Vehicles
  ['ambulance'] = 'Mentőautó',
  ['helicopter_prompt'] = ' [Információ]:omd meg az ~INPUT_CONTEXT~ gombot a helikopter listához.',
  ['garage_prompt'] = ' [Információ]:omd meg az ~INPUT_CONTEXT~ gombot a kocsi listához.',
  ...
  ['actions_prompt'] = ' [Információ]:omd meg az ~INPUT_CONTEXT~ gombot a panel megnyitásához.',
  ['deposit_amount'] = 'Összeg betétele',
  ['money_withdraw'] = 'Összeg kivétele',
  ['fast_travel'] = 'Nyomj ~INPUT_CONTEXT~ hogy használd a liftet',
  ['open_pharmacy'] = ' [Információ]:omd meg az ~INPUT_CONTEXT~ gombot a gyógyszer kivételéhez.',
