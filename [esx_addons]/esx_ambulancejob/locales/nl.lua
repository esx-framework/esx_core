Locales['nl'] = {
  ...
  -- Vehicles
  ['ambulance'] = 'Ambulance',
  ['helicopter_prompt'] = 'Druk op ~INPUT_CONTEXT~ om de Lifeliners te beheren.',
  ['garage_prompt'] = 'Druk op ~INPUT_CONTEXT~ om de Garage te openen.',
  ['garage_title'] = 'Garage',
  ...
  ['actions_prompt'] = 'Druk op ~INPUT_CONTEXT~ om de Ambulance Acties te bekijken.',
