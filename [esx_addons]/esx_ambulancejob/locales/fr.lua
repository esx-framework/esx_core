Locales['fr'] = {
  ...
  -- Vehicles
  ['ambulance'] = 'ambulance',
  ['helicopter_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder aux Actions de l\'hélicoptère.',
  ['garage_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder aux Actions des véhciules.',
  ...
  ['actions_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ accédez aux Actions d\'Ambulance.',
