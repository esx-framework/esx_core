Locales['vi'] = {
	...
	["rot_left_right"] = "Trái/Phải",
	["rot_up_down"] = "Lên/Xuống",
	["zoom"] = "Phóng to/Thu nhỏ",
	["zoom_level"] = "Zoom Level: %s %%",
	["night_vision"] = "Chuyển đổi tầm nhìn ban đêm",
	["clipboard"] = "Link Copied To ~b~Cipboard",
	["picture_taken"] = "Picture Taken!",
	["please_wait"] = "Vui lòng đợi trước khi chụp ảnh ~b~ khác",
	["exit"] = "Thoát",
