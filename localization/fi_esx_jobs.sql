...
INSERT INTO `items` (`name`, `label`, `limit`) VALUES
	('alive_chicken', 'Elävä kana', 20),
	('slaughtered_chicken', 'Teurastettu kana', 20),
	('packaged_chicken', 'Kananfilee', 100),
	('fish', 'Kala', 100),
	('stone', 'Kivi', 7),
	('washed_stone', 'Puhdistettu Kivi', 7),
	('copper', 'Kupari', 56),
	('iron', 'Rauta', 42),
	('gold', 'Kulta', 21),
	('diamond', 'Timantti', 50),
	('wood', 'Puu', 20),
	('cutted_wood', 'Pilkottu Puu', 20),
	('packaged_plank', 'Paketoitu Lankku', 100),
	('petrol', 'Öljy', 24),
