...
INSERT INTO `items` (`name`, `label`) VALUES
  ('alive_chicken', 'Frango Vivo', 20),
  ('slaughtered_chicken', 'Frango Abatido', 20),
  ('packaged_chicken', 'Frango na Bandeja', 100),
  ('fish', 'Peixe', 100),
  ('stone', 'Pedra', 7),
  ('washed_stone', 'Pedra Limpa', 7),
  ('copper', 'Cobre', 56),
  ('iron', 'Ferro', 42),
  ('gold', 'Ouro', 21),
  ('diamond', 'Diamante', 50),
  ('wood', 'Madeira', 20),
  ('cutted_wood', 'Madeira Cortada', 20),
  ('packaged_plank', 'Tábua Embalada', 100),
  ('petrol', 'Petroleo', 24),
