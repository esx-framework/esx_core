Locales['de'] = {
  ...
  ['received_weapon_ammo'] = 'Dudu erhälst %sx %s für dein %s von %s.',
  ...
  ['command_car_car'] = 'Fahrzeugspawnname oder Fahrzeughash',
  ...
  ['command_clearall'] = 'Chat für alle Spieler leeren.',
  ...
  ['command_giveaccountmoney_amount'] = 'Summe zum hinzufügen',
  ...
  ['command_saveall'] = 'Sichern aller Spielern in der Datenbank',
  ['command_setaccountmoney'] = 'Kontostand des Spielers setzen',
  ...
  ['command_setjob_invalid'] = 'Der Rang oder der Job ist nicht gültig.',
  ...
  ['ammo_flaregun'] = 'Signalfackel(munition)',
