Locales["fr"] = {
	...
	["command_setjob_job2"] = "Nom du second métier à définir",
	["command_setjob2_grade"] = "Grade du second métier",
	["command_setjob2_invalid"] = "Le métier, le grade, ou les deux sont invalides",
