...
<template>
    <div class="dialog">
        ...
        <div class="dialog-body">
            <p>Start by creating your identity</p>

            <Form class="dialog-body-form" id="register" action="#" novalidate @submit="onSubmit"
                :validation-schema="schema">
                <div class="dialog-form-group">
                    <label for="firstname">Firstname</label>
                    <div class="dialog-form-validation">
                    ...
                    <ErrorMessage name="firstname" class="dialog-form-message dialog-form-message-error" />
                </div>
                <div class="dialog-form-group">
                    ...
                    <ErrorMessage name="lastname" class="dialog-form-message dialog-form-message-error" />
                </div>
                <div class="dialog-form-group">
                    <label for="dob">Date of birth</label>
                    <Field id="dob" type="text" name="dob" placeholder="mm/dd/yyyy" validateOnInput />
                    <ErrorMessage name="dob" class="dialog-form-message dialog-form-message-error" />
                </div>
                <div class="dialog-form-group">
                    <label for="gender">Gender</label>
                    <div class="dialog-form-group-radio">
                    ...
                    <ErrorMessage name="gender" class="dialog-form-message dialog-form-message-error" />
                </div>
                <div class="dialog-form-group">
                    <label for="height">Height</label>
                    <Field id="height" type="text" name="height" placeholder="175" validateOnInput />
                    <ErrorMessage name="height" class="dialog-form-message dialog-form-message-error" />
                </div>
                <button class="dialog-form-submit" id="submit" type="submit">
