...
function Database.GetIdentity(identifier, callback)
    MySQL.single("SELECT firstname, lastname, dateofbirth, sex, height FROM users WHERE identifier = ?", { identifier }, callback)
end
