...
const isVue3 = (app2) => "config" in app2 && "globalProperties" in app2.config;
const getHooks = (app2) => {
  let vue3;
  if (app2 === "vue2")
    vue3 = false;
...
const triggerIsID = (trigger2) => typeof trigger2 === "string" && trigger2 !== "auto";
const markWaveBoundary = (el, trigger2) => {
  el.dataset.vWaveBoundary = triggerIsID(trigger2) ? trigger2 : "true";
};
...
const createWaveElement = (x, y, size2, options) => {
  const waveElement = document.createElement("div");
  waveElement.style.position = "absolute";
  waveElement.style.width = `${size2}px`;
  waveElement.style.height = `${size2}px`;
...
const wave = (event, el, options) => {
  ...
  const size2 = 2.05 * getDistanceToFurthestCorner(x, y, rect);
  const waveContainer = createContainer(computedStyles, options.tagName);
  const waveEl = createWaveElement(x, y, size2, options);
...
const createDirective = (globalUserOptions = {}, app2 = "vue3") => {
  const globalOptions = Object.assign(Object.assign({}, DEFAULT_PLUGIN_OPTIONS), globalUserOptions);
  const hooks = getHooks(app2);
  const handleTrigger = (event) => {
    const trigger2 = event.currentTarget.dataset.vWaveTrigger;
    const associatedElements = document.querySelectorAll(`[data-v-wave-boundary="${trigger2}"]`);
    ...
    [hooks.mounted](el, { value = {} }) {
      ...
      el.addEventListener("pointerdown", (event) => {
        ...
        if (triggerIsID(options.trigger))
          return;
        const trigger2 = el.querySelector('[data-v-wave-trigger="true"]');
        if (!trigger2 && options.trigger === true)
          return;
        if (trigger2 && !event.composedPath().includes(trigger2))
          return;
  ...
  const triggerDirective = {
    [hooks.mounted](el, { arg: trigger2 = "true" }) {
      el.dataset.vWaveTrigger = trigger2;
      if (trigger2 !== "true")
        el.addEventListener("pointerdown", handleTrigger);
    },
    [hooks.updated](el, { arg: trigger2 = "true" }) {
      el.dataset.vWaveTrigger = trigger2;
      if (trigger2 === "true")
...
const VWave = {
  install(app2, globalUserOptions = {}) {
    if (this.installed)
      return;
    this.installed = true;
    const globalOptions = Object.assign(Object.assign({}, DEFAULT_PLUGIN_OPTIONS), globalUserOptions);
    const { vWave, vWaveTrigger } = createDirective(globalOptions, app2);
    app2.directive(globalOptions.directive, vWave);
    app2.directive(`${globalOptions.directive}-trigger`, vWaveTrigger);
  },
  installed: false,
  createLocalWaveDirective: createDirective
};
var _imports_1 = "data:image/png;base64,";
var _imports_0 = "data:image/png;base64,";
var App_vue_vue_type_style_index_0_scoped_true_lang = "";
var App_vue_vue_type_style_index_1_scoped_true_lang = "";
var App_vue_vue_type_style_index_2_lang = "";
...
const __default__ = {
  ...
  methods: {
    ...
    processMessage(event) {
      ...
      switch (event.action) {
        case "config":
          ...
          this.inputStates.firstname.text = this.config["pleasefillin"];
          this.inputStates.lastname.text = this.config["pleasefillin"];
          this.inputStates.dateofbirth.text = this.config["pleasefillin"];
        case "open":
          this.show = true;
          break;
        case "close":
    ...
    changeGender(to) {
      this.inputs.gender = to;
    },
    getClassForInputState(inputState) {
      switch (inputState) {
        case "firstname":
          if (this.inputStates.firstname.isError == true) {
            return "inputError";
          } else if (this.inputStates.firstname.text.length != 0) {
            return "inputWarning";
          } else {
            return "inputOk";
          }
        case "lastname":
          if (this.inputStates.lastname.isError == true) {
            return "inputError";
          } else if (this.inputStates.lastname.text.length != 0) {
            return "inputWarning";
          } else {
            return "inputOk";
          }
        case "dateofbirth":
          if (this.inputStates.dateofbirth.isError == true) {
            return "inputError";
          } else if (this.inputStates.dateofbirth.text.length != 0) {
            return "inputWarning";
          } else {
            return "inputOk";
          }
    ...
    getImageForInputState(inputState) {
      switch (inputState) {
        case "firstname":
          if (this.inputStates.firstname.isError == true) {
    ...
    getImageUrl(name) {
      return new URL({ "./assets/female.png": _imports_1, "./assets/male.png": _imports_0 }[`./assets/${name}.png`], self.location).href;
    }
  },
  watch: {
    "inputs.firstname": function(val) {
      var whiteSpace = new RegExp("\\s+");
      var specialChars = /[^A-Za-z^^ü-üÜ-Ü^^ä-äÄ-Ä^^ö-öÖ-Ö^ 0-9]/g;
      if (val == "") {
        this.inputStates.firstname.isError = false;
        this.inputStates.firstname.text = this.config["pleasefillin"];
        return;
      }
      if (val.charAt(0) != val.charAt(0).toUpperCase()) {
        this.inputStates.firstname.isError = true;
        this.inputStates.firstname.text = this.config["firstcapitalized"];
        return;
      }
      if (whiteSpace.test(val)) {
        this.inputStates.firstname.isError = true;
        this.inputStates.firstname.text = this.config["firstnamewhitespace"];
        return;
      }
      if (specialChars.test(val)) {
        this.inputStates.firstname.isError = true;
        this.inputStates.firstname.text = this.config["firstnamespecialchar"];
        return;
      }
      for (var i = 0; i < val.length; i++) {
        if (!isNaN(parseInt(val.charAt(i)))) {
          this.inputStates.firstname.isError = true;
          this.inputStates.firstname.text = this.config["firstnamenumbers"];
          return;
        }
      }
      if (val.length < 3) {
        this.inputStates.firstname.isError = true;
        this.inputStates.firstname.text = this.config["firstname3letters"];
        return;
      }
      this.inputStates.firstname.isError = false;
      this.inputStates.firstname.text = "";
    },
    "inputs.lastname": function(val) {
      var whiteSpace = new RegExp("\\s+");
      var specialChars = /[^A-Za-z^^ü-üÜ-Ü^^ä-äÄ-Ä^^ö-öÖ-Ö^ 0-9]/g;
      if (val == "") {
        this.inputStates.lastname.isError = false;
        this.inputStates.lastname.text = this.config["pleasefillin"];
        return;
      }
      if (val.charAt(0) != val.charAt(0).toUpperCase()) {
        this.inputStates.lastname.isError = true;
        this.inputStates.lastname.text = this.config["firstcapitalized"];
        return;
      }
      if (whiteSpace.test(val)) {
        this.inputStates.lastname.isError = true;
        this.inputStates.lastname.text = this.config["lastnamewhitespace"];
        return;
      }
      if (specialChars.test(val)) {
        this.inputStates.lastname.isError = true;
        this.inputStates.lastname.text = this.config["lastnamespecialchar"];
        return;
      }
      for (var i = 0; i < val.length; i++) {
        if (!isNaN(parseInt(val.charAt(i)))) {
          this.inputStates.lastname.isError = true;
          this.inputStates.lastname.text = this.config["lastnamenumbers"];
          return;
        }
      }
      if (val.length < 3) {
        this.inputStates.lastname.isError = true;
        this.inputStates.lastname.text = this.config["lastname3letters"];
        return;
      }
      this.inputStates.lastname.isError = false;
      this.inputStates.lastname.text = "";
    },
    "inputs.dateofbirth": function(val) {
      var whiteSpace = new RegExp("\\s+");
      var specialChars = /[^A-Za-z^^ü-üÜ-Ü^^ä-äÄ-Ä^^ö-öÖ-Ö^^/-/^ 0-9]/g;
      if (val == "") {
        this.inputStates.dateofbirth.isError = false;
        this.inputStates.dateofbirth.text = this.config["pleasefillin"];
        return;
      }
      if (specialChars.test(val)) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthspecialchar"];
        return;
      }
      if (whiteSpace.test(val)) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthwhitespace"];
        return;
      }
      for (var i = 0; i < val.length; i++) {
        if (val.charAt(i) != "/" && isNaN(parseInt(val.charAt(i)))) {
          this.inputStates.dateofbirth.isError = true;
          this.inputStates.dateofbirth.text = this.config["dateofbirthletters"];
          return;
        }
      }
      if (val.match(/\//g) == null || val.match(/\//g).length < 2) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthformat"];
        return;
      }
      let split = val.split("/");
      if (split[0].length != 2) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthday"];
        return;
      }
      if (parseInt(split[0]) > 31 || parseInt(split[0]) < 1) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthday"];
        return;
      }
      if (split[1].length != 2) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthmonth"];
        return;
      }
      ...
      if (split[2].length != 4) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthyear"];
        return;
      }
      if (parseInt(split[2]) > 2003 || parseInt(split[2]) < 1950) {
        this.inputStates.dateofbirth.isError = true;
        this.inputStates.dateofbirth.text = this.config["dateofbirthyear"];
        return;
      }
      this.inputStates.dateofbirth.isError = false;
      this.inputStates.dateofbirth.text = "";
    }
  },
  mounted() {
...
const __injectCSSVars__ = () => {
  useCssVars((_ctx) => ({
    "35da3244": _ctx.config.mainColor
  }));
};
...
const _withScopeId = (n) => (pushScopeId("data-v-3acb38fd"), n = n(), popScopeId(), n);
const _hoisted_1 = {
  key: 0,
  class: "background"
};
...
const _hoisted_4 = { class: "logobox" };
const _hoisted_5 = ["src"];
const _hoisted_6 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "separator" }, null, -1));
const _hoisted_7 = ["innerHTML"];
const _hoisted_8 = { class: "firstnamebox" };
const _hoisted_9 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "somerect" }, null, -1));
const _hoisted_10 = ["placeholder"];
const _hoisted_11 = ["innerHTML"];
const _hoisted_12 = ["src"];
const _hoisted_13 = { class: "text" };
const _hoisted_14 = { class: "lastnamebox" };
const _hoisted_15 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "somerect" }, null, -1));
const _hoisted_16 = ["placeholder"];
const _hoisted_17 = ["innerHTML"];
const _hoisted_18 = ["src"];
const _hoisted_19 = { class: "text" };
const _hoisted_20 = { class: "dobnamebox" };
const _hoisted_21 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "somerect" }, null, -1));
const _hoisted_22 = ["placeholder"];
const _hoisted_23 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("span", { class: "description" }, "dd/mm/yyyy", -1));
const _hoisted_24 = ["src"];
const _hoisted_25 = { class: "text" };
const _hoisted_26 = { class: "genderbox" };
...
const _hoisted_31 = { class: "heightbox" };
const _hoisted_32 = { class: "heighttext" };
const _hoisted_33 = ["innerHTML"];
const _hoisted_34 = { class: "rightbox" };
const _hoisted_35 = ["innerHTML"];
const _hoisted_36 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "line" }, null, -1));
const _hoisted_37 = { class: "othertext" };
const _hoisted_38 = ["innerHTML"];
const _hoisted_39 = { class: "infoboxes" };
const _hoisted_40 = { class: "info" };
const _hoisted_41 = ["src"];
const _hoisted_42 = { class: "infobox" };
const _hoisted_43 = ["innerHTML"];
const _hoisted_44 = { class: "textbox" };
const _hoisted_45 = ["innerHTML"];
const _hoisted_46 = { class: "info" };
const _hoisted_47 = ["src"];
const _hoisted_48 = { class: "infobox" };
const _hoisted_49 = ["innerHTML"];
const _hoisted_50 = { class: "textbox" };
const _hoisted_51 = ["innerHTML"];
const _hoisted_52 = { class: "info" };
const _hoisted_53 = ["src"];
const _hoisted_54 = { class: "infobox" };
const _hoisted_55 = ["innerHTML"];
const _hoisted_56 = { class: "textbox" };
const _hoisted_57 = ["innerHTML"];
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _directive_ripple = resolveDirective("ripple");
  return openBlock(), createElementBlock(Fragment, null, [
    $data.show == true ? (openBlock(), createElementBlock("div", _hoisted_1)) : createCommentVNode("", true),
    $data.show == true ? (openBlock(), createElementBlock("div", _hoisted_2, [
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("span", {
          class: "titletext",
          innerHTML: $data.config["titletext"]
        }, null, 8, _hoisted_7),
        createBaseVNode("div", _hoisted_8, [
          ...
          withDirectives(createBaseVNode("input", {
            type: "text",
            class: "input",
            placeholder: $data.config["firstnameplaceholder"],
            maxlength: "16",
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.inputs.firstname = $event)
          }, null, 8, _hoisted_10), [
            [vModelText, $data.inputs.firstname]
          ]),
          createBaseVNode("span", {
            class: "description",
            innerHTML: $data.config["maxchars"]
          }, null, 8, _hoisted_11),
          createBaseVNode("div", {
            class: normalizeClass(["inputState", $options.getClassForInputState("firstname")])
          }, [
            createBaseVNode("img", {
              class: "inputIcon",
              src: $options.getImageForInputState("firstname")
            }, null, 8, _hoisted_12),
            createBaseVNode("span", _hoisted_13, toDisplayString($data.inputStates.firstname.text), 1)
          ], 2)
        ]),
        createBaseVNode("div", _hoisted_14, [
          ...
          withDirectives(createBaseVNode("input", {
            type: "text",
            class: "input",
            placeholder: $data.config["lastnameplaceholder"],
            maxlength: "16",
            "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => $data.inputs.lastname = $event)
          }, null, 8, _hoisted_16), [
            [vModelText, $data.inputs.lastname]
          ]),
          createBaseVNode("span", {
            class: "description",
            innerHTML: $data.config["maxchars"]
          ...
          createBaseVNode("div", {
            class: normalizeClass(["inputState", $options.getClassForInputState("lastname")])
          }, [
            createBaseVNode("img", {
              class: "inputIcon",
              src: $options.getImageForInputState("lastname")
            }, null, 8, _hoisted_18),
            createBaseVNode("span", _hoisted_19, toDisplayString($data.inputStates.lastname.text), 1)
          ], 2)
        ]),
        createBaseVNode("div", _hoisted_20, [
          ...
          withDirectives(createBaseVNode("input", {
            type: "text",
            class: "input",
            placeholder: $data.config["dateofbirthplaceholder"],
            maxlength: "10",
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $data.inputs.dateofbirth = $event)
          }, null, 8, _hoisted_22), [
            [vModelText, $data.inputs.dateofbirth]
          ]),
          _hoisted_23,
          createBaseVNode("div", {
            class: normalizeClass(["inputState", $options.getClassForInputState("dateofbirth")])
          }, [
            createBaseVNode("img", {
              class: "inputIcon",
              src: $options.getImageForInputState("dateofbirth")
            }, null, 8, _hoisted_24),
            createBaseVNode("span", _hoisted_25, toDisplayString($data.inputStates.dateofbirth.text), 1)
          ], 2)
        ]),
        createBaseVNode("div", _hoisted_26, [
          withDirectives((openBlock(), createElementBlock("div", {
            class: normalizeClass(["gender1 gender", { genderactive: $data.inputs.gender == 0 }]),
            onClick: _cache[3] || (_cache[3] = ($event) => $options.changeGender(0))
          }, _hoisted_28, 2)), [
            [_directive_ripple]
          ]),
          withDirectives((openBlock(), createElementBlock("div", {
            class: normalizeClass(["gender2 gender", { genderactive: $data.inputs.gender == 1 }]),
            onClick: _cache[4] || (_cache[4] = ($event) => $options.changeGender(1))
          }, _hoisted_30, 2)), [
            [_directive_ripple]
          ])
        ]),
        createBaseVNode("div", _hoisted_31, [
          createBaseVNode("span", _hoisted_32, toDisplayString($data.config["height"]) + ": " + toDisplayString($data.inputs.height) + "cm", 1),
          withDirectives(createBaseVNode("input", {
            type: "range",
            class: "slider",
            min: 120,
            max: 200,
            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $data.inputs.height = $event)
          }, null, 512), [
            [vModelText, $data.inputs.height]
          ])
        ]),
        withDirectives((openBlock(), createElementBlock("div", {
          class: "createButton",
          onClick: _cache[6] || (_cache[6] = ($event) => $options.finish())
        }, [
          createBaseVNode("span", {
            class: "text",
            innerHTML: $data.config["createtext"]
          }, null, 8, _hoisted_33)
        ])), [
          [_directive_ripple]
        ])
      ...
      createBaseVNode("div", _hoisted_34, [
        createBaseVNode("span", {
          class: "texttitle",
          innerHTML: $data.config["infotitle"]
        }, null, 8, _hoisted_35),
        _hoisted_36,
        createBaseVNode("div", _hoisted_37, [
          createBaseVNode("span", {
            class: "text",
            innerHTML: $data.config["infotext"]
          }, null, 8, _hoisted_38)
        ]),
        createBaseVNode("div", _hoisted_39, [
          createBaseVNode("div", _hoisted_40, [
            createBaseVNode("img", {
              class: "icon",
              draggable: "false",
              src: $data.config["linkicon1"]
            }, null, 8, _hoisted_41),
            createBaseVNode("div", _hoisted_42, [
              withDirectives((openBlock(), createElementBlock("div", {
                class: "copybox",
                onClick: _cache[7] || (_cache[7] = ($event) => $options.copyToClipboard($data.config["link1"]))
              }, [
                createBaseVNode("span", {
                  class: "copytext",
                  innerHTML: $data.config["clicktocopy"]
                }, null, 8, _hoisted_43)
              ])), [
                [_directive_ripple]
              ]),
          ...
          createBaseVNode("div", _hoisted_46, [
            createBaseVNode("img", {
              class: "icon",
              draggable: "false",
              src: $data.config["linkicon2"]
            }, null, 8, _hoisted_47),
            createBaseVNode("div", _hoisted_48, [
              withDirectives((openBlock(), createElementBlock("div", {
                class: "copybox",
                onClick: _cache[8] || (_cache[8] = ($event) => $options.copyToClipboard($data.config["link2"]))
              }, [
                createBaseVNode("span", {
                  class: "copytext",
                  innerHTML: $data.config["clicktocopy"]
          ...
          createBaseVNode("div", _hoisted_52, [
            createBaseVNode("img", {
              class: "icon",
              draggable: "false",
              src: $data.config["linkicon3"]
            }, null, 8, _hoisted_53),
            createBaseVNode("div", _hoisted_54, [
              withDirectives((openBlock(), createElementBlock("div", {
                class: "copybox",
                onClick: _cache[9] || (_cache[9] = ($event) => $options.copyToClipboard($data.config["link3"]))
              }, [
                createBaseVNode("span", {
                  class: "copytext",
                  innerHTML: $data.config["clicktocopy"]
...
var App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3acb38fd"]]);
