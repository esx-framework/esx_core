Locales["es"] = {
	...
	["char_disabled_description"] = "Este personaje es inutilizable.",
        ["char_delete_confirmation"] = "Confirma borrado",
        ["char_delete_confirmation_description"] = "Estas seguro de eliminar el personaje seleccionado?",
        ["char_delete_yes_description"] = "Si, estoy seguro de eliminar el personaje seleccionado",
        ["char_delete_no_description"] = "No, volver a las opciones del personaje", 
