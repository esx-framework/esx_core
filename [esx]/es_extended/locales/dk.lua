Locales['dk'] = {
  ...
  ['commanderror_console'] = 'Kommando kan ikke blive udført fra konsol',
  ...
  ['command_giveammo_noweapon_found'] = '%s har ikke dette våben',
  ['command_giveammo_weapon'] = 'Våben navn',
  ['command_giveammo_ammo'] = 'Ammunition antal',
  ...
  ['component_scope_holo'] = 'holographic sigte',
  ...
  ['ammo_shells'] = 'shell(s)',
  ['ammo_charge'] = 'charge',
  ['ammo_petrol'] = 'liter af brændstof',
  ['ammo_firework'] = 'fyrværkeri',
  ['ammo_rockets'] = 'raketter',
  ['ammo_grenadelauncher'] = 'grenader',
  ['ammo_grenade'] = 'grenade(s)',
  ['ammo_stickybomb'] = 'bomber',
  ['ammo_pipebomb'] = 'bomber',
  ['ammo_smokebomb'] = 'bomber',
