...
ESX.RegisterCommand('car', 'admin', function(xPlayer, args, showError)
    ...
    ESX.OneSync.SpawnVehicle(args.car, coords - vector3(0, 0, 0.9), GetEntityHeading(PlayerPed), upgrades,
        function(networkId)
...
ESX.RegisterCommand('info', { "user", "admin" }, function(xPlayer, args, showError)
    ...
    print("^2ID : ^5" ..
        xPlayer.source ..
        " ^0| ^2Name:^5" .. xPlayer.getName() .. " ^0 | ^2Group:^5" .. xPlayer.getGroup() .. "^0 | ^2Job:^5" .. job ..
        "^0")
end, true)
