Locales['fr'] = {
  ...
  ['chest_hair'] = 'pillosité torse',
  ['chest_hair_1'] = 'opacité pillosité',
  ['chest_color'] = 'couleur pillosité',
  ['bodyb'] = 'imperfections du corps',
  ['bodyb_size'] = 'opacité imperfections',
  ['bodyb_extra'] = 'effet imperfections sur le corps',
  ['bodyb_extra_thickness'] = 'imperfections l\'épaisseur de l\'effet corporel'  
}
