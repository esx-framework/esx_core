...
-- Dumping data for table es_extended.addon_account_data: ~10 rows (approximately)
...
-- Dumping data for table es_extended.datastore: ~10 rows (approximately)
...
INSERT INTO `datastore` (`name`, `label`, `shared`) VALUES
	...
	('society_mechanic', 'Mechanic', 1),
	('society_police', 'Police', 1),
	('society_realestateagent', 'Taxi', 1),
	('society_taxi', 'Real Estate Company', 1),
	('user_ears', 'Ears', 0),
...
-- Dumping data for table es_extended.datastore_data: ~10 rows (approximately)
...
INSERT INTO `datastore_data` (`id`, `name`, `owner`, `data`) VALUES
	...
	(4, 'society_taxi', NULL, '{}'),
	(5, 'society_realestateagent', NULL, '{}');
...
-- Dumping data for table es_extended.inventories: ~0 rows (approximately)
/*!40000 ALTER TABLE `inventories` DISABLE KEYS */;
/*!40000 ALTER TABLE `inventories` ENABLE KEYS */;

-- Dumping data for table es_extended.items: ~33 rows (approximately)
...
INSERT INTO `job_grades` (`id`, `job_name`, `grade`, `name`, `label`, `salary`, `skin_male`, `skin_female`) VALUES
	...
	(28, 'realestateagent', 0, 'location', 'Renting Agent', 10, '{}', '{}'),
	(29, 'realestateagent', 1, 'vendeur', 'Agent', 25, '{}', '{}'),
	(30, 'realestateagent', 2, 'gestion', 'Management', 40, '{}', '{}'),
	(31, 'realestateagent', 3, 'boss', 'Broker', 0, '{}', '{}'),
