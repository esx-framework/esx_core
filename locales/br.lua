Locales['br'] = {
  ...
  ['recived_weapon'] = 'voce recebeu ~y~1x~s~ ~b~%s~s~ com ~o~%sx~s~ balas de ~b~%s~s~.',
  ['gave_ammo'] = 'voce deu ~o~%sx~s~ balas para ~y~%s~s~.',
  ['recived_ammo'] = 'voce recebeu ~o~%sx~s~ balas de ~b~%s~s~.',
  ['giveammo'] = 'Dar muniçao',
  ['amount_invalid'] = 'quantidade invalida',
  ['players_nearby'] = 'nenhum jogador por perto',
  ['ex_inv_lim'] = 'acao nao e possivel, excedendo o limite de estoque para ~b~',
  ['yougave'] = 'voce deu',
  ['youreceived'] = 'voce recebeu',
  ['to'] = '~s~ para ~b~',
  ['by'] = '~s~ de ~b~',
  ...
  -- Relacionado com salario
  ['recived_salary'] = 'voce recebeu seu salario:  ~g~$%s~s~ ',
  ['recived_help'] = 'voce recebeu seu cheque de bem-estar: ~g~$%s~s~ ',
