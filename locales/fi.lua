Locales['fi'] = {
  ...
  ['recived_weapon'] = 'sinä sait ~y~1x~s~ ~b~%s~s~ jossa oli ~o~%sx~s~ ammuksia henkilöltä ~b~%s~s~.',
  ['gave_ammo'] = 'sinä annoit ~o~%sx~s~ ammuksia henkilölle ~y~%s~s~.',
  ['recived_ammo'] = 'sinä sait ~o~%sx~s~ ammuksia henkilöltä ~b~%s~s~.',
  ['giveammo'] = 'anna ammuksia',
  ['amount_invalid'] = 'virheellinen määrä',
  ['players_nearby'] = 'ei pelaajia lähettyvillä',
  ['ex_inv_lim'] = 'toiminto mahdoton, reppu alkaa olla täysi ~b~',
  ['yougave'] = 'sinä annoit',
  ['youreceived'] = 'sinä sait',
  ['to'] = '~s~ henkilölle ~b~',
  ['by'] = '~s~ henkilöltä ~b~',
  ...
  -- Salary related
  ['recived_salary'] = 'sinä vastaanotit palkkaa: ~g~$%s~s~',
  ['recived_help'] = 'sinä vastaanotit valtion tukea: ~g~$%s~s~',
  ['company_nomoney'] = 'yritys jolle teet töitä on köyhä eikä voi maksaa palkkaasi.',
  ['recived_money'] = 'sai rahaa',
  ['bank'] = 'Pankki',
