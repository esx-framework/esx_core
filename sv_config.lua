...
Config.Animations = {
...

	{
	    ...
	    {label = "Mekaniker: reparation under fordon", type = "scenario", data = {anim = "world_human_vehicle_mechanic"}},
...

	{
	    ...
	    {label = "Sätt dig ner", type = "scenario", data = {anim = "WORLD_HUMAN_PICNIC"}},
